...
public class MyController {
	...
	public loads getLoads(@PathVariable String loadId)
	{
	...
	public loads putLoads(@PathVariable String loadId)
	{
		
		return this.loadService.putLoads(Long.parseLong(loadId));
	}
}
